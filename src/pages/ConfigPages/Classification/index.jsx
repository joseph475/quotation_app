...
class Classifications extends Component {
  ...
  onClassficationUpdate = async () => {
    ...
    const oldData = fetchLocalStorage(apiEndpointKey);
  ...
  async fetchData() {
    const strgClassifications = fetchLocalStorage(apiEndpointKey);
    ...
    return (
      <div class="container mx-auto">
        <form class="flex items-center justify-end mb-5 ">
          <div class="mr-3">
            <Search
              data={fetchLocalStorage(apiEndpointKey)}
              setSearchResults={this.setSearchResults}
              searchColumns={searchColumns}
              searchPlaceHolder={`Add ${apiEndpointKey} here`}
        ...
        <div class="overflow-y-auto h-[700px] shadow-md">
